...
export const AppliedFiltersChip = ({ text, index }: ChipProps) => {
    ...
    return (
        <span onClick={handleClick} id="badge-dismiss-default" className="inline-flex w-max cursor-pointer items-center px-2 py-1 mr-2 text-sm font-medium bg-slate-800 text-white rounded">
            {text}
