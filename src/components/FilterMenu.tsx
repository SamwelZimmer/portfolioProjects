...
import { FilterChip, AppliedFiltersChip } from "./common/Chips";
  ...
  return (
    ...
    >
      ...
      >
        <div
          onClick={handleClose}
          className="absolute -top-10 left-1/2 -translate-x-1/2 border border-b-white bg-white w-32 rounded-t-lg flex justify-center items-center p-2 text-gray-400 font-light cursor-pointer"
        >
          filter
        </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-row overflow-scroll w-full scrollable-but-hidden-scrollbar">
              {projectCategories.length === 0 ? (
                <div className="opacity-30 font-light text-sm py-1">
                  {"("}no filters applied{")"}
                </div>
              ) : (
